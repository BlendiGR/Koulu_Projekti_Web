...
const Success = () => {
  ...
  return (
    <div className="flex items-center text-center justify-center bg-beige h-[calc(100vh-5rem)]">
      <div className="flex flex-col items-center gap-4">
        ...
        <button 
          onClick={() => navigate("/")}
          className="bg-white hover:bg-gray-100 active:bg-gray-300 text-black rounded-xl shadow-sm active:scale-101 transition-all duration-200 cursor-pointer md:text-2xl py-3 px-5 w-[50%]"
        >
          {t("success.home")}
        </button>
      </div>
